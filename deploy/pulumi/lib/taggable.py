"""Taggable module helps determine which AWS resources can be tagged."""
...
def is_taggable(resource_type):
    """Check if the given resource type is in the list of taggable resource types."""
    return resource_type in taggable_resource_types
